...
import { MapPin, Globe, RefreshCw, ChevronRight, Info, Shield, Database } from 'lucide-react-native';
                ...
                >
                  <HStack space="md">
                    <Box
                      ...
                      p={SPACING.sm}
                    >
                      <Database size={ICON_SIZES.lg} color={COLORS.warning} />
                    </Box>
                    <VStack flex={1} justifyContent="center">
                      <Text fontSize={12} color={COLORS.textSecondary}>
                        {t('setup.totalReports')}
                      </Text>
                      <Text fontSize={24} color={COLORS.text} fontWeight="700" mt={4}>
                        {localReports.length}
                      </Text>
                    </VStack>
                  </HStack>
                ...
                >
                  <HStack space="md">
                    <Box
                      ...
                      p={SPACING.sm}
                    >
                      <RefreshCw size={ICON_SIZES.lg} color={COLORS.offline} />
                    </Box>
                    <VStack flex={1} justifyContent="center">
                      <Text fontSize={12} color={COLORS.textSecondary}>
                        {t('setup.pendingSync')}
