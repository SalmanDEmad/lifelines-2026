/*
// ============================================================================
// NOTIFICATIONS FUNCTIONALITY - DISABLED FOR DEMO
// ============================================================================
// All notification features are commented out to prevent errors during demo.
...
// ============================================================================
// STUB IMPLEMENTATIONS FOR DISABLED NOTIFICATIONS
// ============================================================================
...
export async function registerForPushNotifications(): Promise<string | null> {
  console.log('[DISABLED] Push notifications disabled for demo');
  return null;
}

export async function registerDeviceForNotifications(): Promise<boolean> {
  console.log('[DISABLED] Device notifications disabled for demo');
  return false;
}
...
export function subscribeToHazardAlerts() {
  console.log('[DISABLED] Hazard alerts disabled for demo');
  return null;
}
...
export async function notifySyncComplete(): Promise<void> {
  console.log('[DISABLED] Sync notifications disabled for demo');
}

export async function notifyReportSynced(): Promise<void> {
  console.log('[DISABLED] Report sync notifications disabled for demo');
}
